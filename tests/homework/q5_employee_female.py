...
# 아래 함수를 실행하면, Tuple 리스트를 반환해야합니다. 결과 값의 각 레코드의 칼럼 순서는 반드시 아래의 순서로 되어야 합니다.(e.g 직위가 먼저 올 경우 오답 처리됩니다.)
# 리턴 타입의 예는 아래와 같습니다.(나이, 포지션 순)
# [(30, "position1"), (23, "position2")]
...
def find_employee_female_table():
    import psycopg
